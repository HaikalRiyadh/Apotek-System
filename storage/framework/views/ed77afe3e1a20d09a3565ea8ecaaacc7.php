...
<?php endif; ?>
    ...
    <form method="POST" action="<?php echo e(route('login')); ?>" class="space-y-5" x-data="{ showPass: false }">
        <?php echo csrf_field(); ?>
        ...
        <div>
            <div class="flex items-center justify-between mb-1.5">
                ...
                <?php if(Route::has('password.request')): ?>
                    <a class="text-xs text-emerald-600 hover:text-emerald-700 font-semibold transition-colors" href="<?php echo e(route('password.request')); ?>">
                        Lupa password?
                    </a>
                <?php endif; ?>
            </div>
...
<?php endif; ?>
        ...
        <p class="text-center text-sm text-slate-500">
            Belum punya akun?
            <a class="text-emerald-600 hover:text-emerald-700 font-semibold transition-colors" href="<?php echo e(route('register')); ?>">
                Daftar sekarang
            </a>
        </p>
        <?php endif; ?>
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\Apotek_system\resources\views/auth/login.blade.php ENDPATH**/ ?>
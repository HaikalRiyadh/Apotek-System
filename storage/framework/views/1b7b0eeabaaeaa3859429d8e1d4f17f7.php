...
<?php $component->withAttributes([]); ?>
    ...
    <form method="POST" action="<?php echo e(route('register')); ?>" class="space-y-5" x-data="{ showPass: false, showConfirm: false }">
        <?php echo csrf_field(); ?>
...
<?php endif; ?>
        ...
        <p class="text-center text-sm text-slate-500">
            Sudah punya akun?
            <a class="text-emerald-600 hover:text-emerald-700 font-semibold transition-colors" href="<?php echo e(route('login')); ?>">
                Masuk di sini
            </a>
        </p>
    </form>
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\Apotek_system\resources\views/auth/register.blade.php ENDPATH**/ ?>
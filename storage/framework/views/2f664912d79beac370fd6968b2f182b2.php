...
<aside :class="sidebarOpen ? 'sidebar mobile-open' : 'sidebar'"
    ...
    <nav class="flex-1 overflow-y-auto py-4 space-y-1">
        ...
        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('view medicines')): ?>
        <a href="<?php echo e(route('medicines.index')); ?>"
           class="sidebar-link <?php echo e(request()->routeIs('medicines.*') ? 'active' : ''); ?>">
        ...
        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('manage units')): ?>
        <a href="<?php echo e(route('units.index')); ?>"
           class="sidebar-link <?php echo e(request()->routeIs('units.*') ? 'active' : ''); ?>">
        ...
        <a href="<?php echo e(route('suppliers.index')); ?>"
           class="sidebar-link <?php echo e(request()->routeIs('suppliers.*') ? 'active' : ''); ?>">
        ...
        <a href="<?php echo e(route('sales.create')); ?>"
           class="sidebar-link <?php echo e(request()->routeIs('sales.create') ? 'active' : ''); ?>">
        ...
        <a href="<?php echo e(route('sales.index')); ?>"
           class="sidebar-link <?php echo e(request()->routeIs('sales.index') || request()->routeIs('sales.show') ? 'active' : ''); ?>">
        ...
        <a href="<?php echo e(route('purchases.index')); ?>"
           class="sidebar-link <?php echo e(request()->routeIs('purchases.*') ? 'active' : ''); ?>">
        ...
        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('edit medicines')): ?>
        <a href="<?php echo e(route('stock-adjustments.index')); ?>"
           class="sidebar-link <?php echo e(request()->routeIs('stock-adjustments.*') ? 'active' : ''); ?>">
        ...
        <div x-data="{ reportExpand: <?php echo e(request()->routeIs('reports.*') ? 'true' : 'false'); ?> }">
            <button @click="reportExpand = !reportExpand"
                class="sidebar-link w-full <?php echo e(request()->routeIs('reports.*') ? 'text-emerald-400' : ''); ?>">
            ...
            <div x-show="reportExpand" x-collapse x-cloak class="mt-1 space-y-0.5 ml-5 border-l border-white/10 pl-3">
                <a href="<?php echo e(route('reports.sales')); ?>" class="sidebar-link !mx-0 !px-3 text-xs <?php echo e(request()->routeIs('reports.sales') ? 'active' : ''); ?>">
                    <span class="w-1.5 h-1.5 rounded-full <?php echo e(request()->routeIs('reports.sales') ? 'bg-emerald-400' : 'bg-slate-500'); ?>"></span>
                    <span>Penjualan</span>
                </a>
                <a href="<?php echo e(route('reports.purchases')); ?>" class="sidebar-link !mx-0 !px-3 text-xs <?php echo e(request()->routeIs('reports.purchases') ? 'active' : ''); ?>">
                    <span class="w-1.5 h-1.5 rounded-full <?php echo e(request()->routeIs('reports.purchases') ? 'bg-emerald-400' : 'bg-slate-500'); ?>"></span>
                    <span>Pembelian</span>
                </a>
                <a href="<?php echo e(route('reports.stock')); ?>" class="sidebar-link !mx-0 !px-3 text-xs <?php echo e(request()->routeIs('reports.stock') ? 'active' : ''); ?>">
                    <span class="w-1.5 h-1.5 rounded-full <?php echo e(request()->routeIs('reports.stock') ? 'bg-emerald-400' : 'bg-slate-500'); ?>"></span>
                    <span>Stok Obat</span>
                </a>
                <a href="<?php echo e(route('reports.expiring')); ?>" class="sidebar-link !mx-0 !px-3 text-xs <?php echo e(request()->routeIs('reports.expiring') ? 'active' : ''); ?>">
                    <span class="w-1.5 h-1.5 rounded-full <?php echo e(request()->routeIs('reports.expiring') ? 'bg-emerald-400' : 'bg-slate-500'); ?>"></span>
                    <span>Hampir Expired</span>
                </a>
                <a href="<?php echo e(route('reports.gross-profit')); ?>" class="sidebar-link !mx-0 !px-3 text-xs <?php echo e(request()->routeIs('reports.gross-profit') ? 'active' : ''); ?>">
                    <span class="w-1.5 h-1.5 rounded-full <?php echo e(request()->routeIs('reports.gross-profit') ? 'bg-emerald-400' : 'bg-slate-500'); ?>"></span>
        ...
        <a href="<?php echo e(route('activity-logs.index')); ?>"
           class="sidebar-link <?php echo e(request()->routeIs('activity-logs.*') ? 'active' : ''); ?>">
    ...
    <div class="border-t border-white/10 p-4">
        <div class="flex items-center gap-3">
            ...
            <div class="overflow-hidden">
                ...
                <p class="text-[11px] text-slate-400 truncate"><?php echo e(Auth::user()->roles->pluck('name')->first()); ?></p>
            </div>
        </div>
    </div>
</aside>
<?php /**PATH C:\laragon\www\Apotek_system\resources\views/layouts/navigation.blade.php ENDPATH**/ ?>
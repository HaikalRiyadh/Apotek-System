<section class="space-y-6">
    <header>
        ...
        <p class="mt-1 text-sm text-slate-500">
            <?php echo e(__('Setelah akun Anda dihapus, semua data akan dihapus secara permanen. Sebelum menghapus akun, silakan unduh data yang ingin Anda simpan.')); ?>
...
<?php $component->withAttributes(['name' => 'confirm-user-deletion','show' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($errors->userDeletion->isNotEmpty()),'focusable' => true]); ?>
        <form method="post" action="<?php echo e(route('profile.destroy')); ?>" class="p-6">
            ...
            <p class="mt-1 text-sm text-slate-500">
                <?php echo e(__('Setelah akun dihapus, semua data akan hilang permanen. Masukkan password Anda untuk mengkonfirmasi penghapusan.')); ?>
...
<?php /**PATH C:\laragon\www\Apotek_system\resources\views/profile/partials/delete-user-form.blade.php ENDPATH**/ ?>
            ...
            <?php if($expiredBatches->isEmpty()): ?>
                <div class="card">
                    <div class="card-body py-16 text-center">
                        ...
                        <a href="<?php echo e(route('stock-adjustments.index')); ?>" class="btn-primary mt-4 inline-flex">Kembali</a>
                    </div>
                </div>
            <?php else: ?>
                <form method="POST" action="<?php echo e(route('stock-adjustments.dispose-expired.store')); ?>" x-data="{ selectedAll: false, selected: [] }">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="bg-gradient-to-r from-red-500 to-rose-600 rounded-2xl p-6 text-white mb-6">
                        <div class="flex items-center gap-4">
                            ...
                            <div>
                                <h3 class="text-2xl font-bold"><?php echo e($expiredBatches->count()); ?> Batch Expired</h3>
                                <p class="text-red-100 text-sm">Total <?php echo e($expiredBatches->sum('remaining_quantity')); ?> unit obat yang sudah melewati tanggal kadaluarsa</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card">
                        <div class="card-header flex items-center justify-between">
                            ...
                            <label class="flex items-center gap-2 cursor-pointer text-sm text-slate-600">
                                <input type="checkbox" x-model="selectedAll"
                                       @change="selected = selectedAll ? <?php echo e($expiredBatches->pluck('id')); ?> : []"
                        ...
                        <div class="overflow-x-auto">
                            <table class="pro-table">
                                ...
                                <tbody>
                                    <?php $__currentLoopData = $expiredBatches; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $batch): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            <td>
                                                <input type="checkbox" name="batch_ids[]" value="<?php echo e($batch->id); ?>"
                                                       x-model="selected" :value="<?php echo e($batch->id); ?>"
                                                       class="rounded border-slate-300 text-emerald-600 focus:ring-emerald-500/20">
                                            </td>
                                            ...
                                            <td class="text-red-600 font-medium"><?php echo e($batch->expired_date->format('d/m/Y')); ?></td>
                                            <td class="text-center font-bold"><?php echo e($batch->remaining_quantity); ?></td>
                                            <td>
                                                <?php $daysExpired = now()->diffInDays($batch->expired_date); ?>
                                                <span class="badge badge-danger">Expired <?php echo e($daysExpired); ?> hari</span>
                                            </td>
                                        </tr>
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\Apotek_system\resources\views/stock-adjustments/dispose-expired.blade.php ENDPATH**/ ?>
        ...
        <div class="min-h-screen flex">
            ...
            <div class="hidden lg:flex lg:w-[55%] mesh-gradient flex-col justify-between p-12 relative overflow-hidden">
                ...
                <div class="relative z-10 flex items-center justify-between">
                    <p class="text-slate-500 text-xs">&copy; <?php echo e(date('Y')); ?> Apotek Kita Sehat. All rights reserved.</p>
            ...
            <div class="flex-1 flex flex-col justify-center items-center p-6 sm:p-12 bg-gray-50 relative">
                ...
                <p class="mt-10 text-xs text-slate-400 text-center lg:hidden relative z-10">&copy; <?php echo e(date('Y')); ?> Apotek Kita Sehat</p>
            </div>
        </div>
    </body>
</html>
<?php /**PATH C:\laragon\www\Apotek_system\resources\views/layouts/guest.blade.php ENDPATH**/ ?>
...
<?php $component->withAttributes([]); ?>
    ...
    <div class="max-w-7xl mx-auto space-y-6 animate-fade-in">
        <div class="flex items-center justify-between">
            ...
            <a href="<?php echo e(route('purchases.create')); ?>" class="btn-primary">
        ...
        <div class="card">
            <div class="card-body">
                <form method="GET" action="<?php echo e(route('purchases.index')); ?>" class="flex flex-wrap gap-4 items-end">
                    <div class="flex-1 min-w-[200px]">
                        ...
                        <div class="relative">
                            ...
                            <input type="text" name="search" value="<?php echo e(request('search')); ?>" placeholder="No. invoice atau supplier..."
                    ...
                    <div class="flex gap-2">
                        ...
                        <?php if(request()->hasAny(['search', 'start_date', 'end_date', 'status'])): ?>
                            <a href="<?php echo e(route('purchases.index')); ?>" class="btn-secondary !py-2">Reset</a>
                        <?php endif; ?>
                    </div>
                </form>
            </div>
        ...
        <div class="card">
                    ...
                    <tbody>
                        <?php $__empty_1 = true; $__currentLoopData = $purchases; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $purchase): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr>
                                ...
                                <td class="text-slate-600"><?php echo e($purchase->supplier->name ?? '-'); ?></td>
                                <td class="text-slate-500"><?php echo e($purchase->purchase_date->format('d/m/Y')); ?></td>
                                <td class="text-right font-semibold text-slate-700">Rp <?php echo e(number_format($purchase->total_amount, 0, ',', '.')); ?></td>
                                <td class="text-slate-500"><?php echo e($purchase->user->name ?? '-'); ?></td>
            ...
            <div class="px-6 py-4 border-t border-slate-100"><?php echo e($purchases->withQueryString()->links()); ?></div>
            <?php endif; ?>
        </div>
    </div>
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\Apotek_system\resources\views/purchases/index.blade.php ENDPATH**/ ?>
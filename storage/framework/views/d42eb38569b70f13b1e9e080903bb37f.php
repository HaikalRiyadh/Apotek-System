...
<?php $component->withAttributes([]); ?>
    ...
    <div class="max-w-7xl mx-auto space-y-6 animate-fade-in">
        <div class="flex items-center justify-between">
            ...
            <a href="<?php echo e(route('units.create')); ?>" class="btn-primary">
        ...
        <div class="card">
                ...
                <table class="pro-table">
                    ...
                    <tbody>
                        <?php $__empty_1 = true; $__currentLoopData = $units; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $unit): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr>
                                <td class="text-slate-400 font-medium"><?php echo e($loop->iteration + ($units->currentPage() - 1) * $units->perPage()); ?></td>
                                <td class="font-semibold text-slate-700"><?php echo e($unit->name); ?></td>
                                <td><span class="badge badge-info"><?php echo e($unit->abbreviation); ?></span></td>
                                <td class="text-center">
                                    <span class="text-slate-600 font-medium"><?php echo e($unit->medicines_count ?? $unit->medicines->count()); ?></span>
                                </td>
                                <td class="text-center">
                                    <div class="flex items-center justify-center gap-1.5">
                                        <a href="<?php echo e(route('units.edit', $unit)); ?>"
                                        ...
                                        <form action="<?php echo e(route('units.destroy', $unit)); ?>" method="POST" class="delete-form">
            ...
            <div class="px-6 py-4 border-t border-slate-100"><?php echo e($units->links()); ?></div>
            <?php endif; ?>
        </div>
    </div>
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\Apotek_system\resources\views/units/index.blade.php ENDPATH**/ ?>
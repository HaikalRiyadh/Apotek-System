    ...
    <div class="max-w-7xl mx-auto space-y-6 animate-fade-in">
        <div class="flex items-center justify-between">
            ...
            <div class="card print:hidden">
                <div class="card-body">
                    <form method="GET" action="<?php echo e(route('reports.sales')); ?>" class="flex flex-wrap items-end gap-4">
                        <div>
            ...
            <div class="bg-gradient-to-r from-emerald-500 to-teal-600 rounded-2xl p-6 text-white shadow-lg shadow-emerald-500/20">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-3xl font-bold mt-1">Rp <?php echo e(number_format($totalSales, 0, ',', '.')); ?></p>
                    </div>
                        ...
                        <tbody>
                            <?php $__empty_1 = true; $__currentLoopData = $sales; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $sale): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr>
                                    ...
                                    <td><?php echo e(\Carbon\Carbon::parse($sale->sale_date)->format('d/m/Y H:i')); ?></td>
                                    <td class="text-right font-semibold">Rp <?php echo e(number_format($sale->grand_total, 0, ',', '.')); ?></td>
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\Apotek_system\resources\views/reports/sales.blade.php ENDPATH**/ ?>
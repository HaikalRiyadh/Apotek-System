                ...
                <form method="POST" action="{{ route('medicines.store') }}" class="space-y-5">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-5">
                        <div>
                            ...
                            <input type="number" id="default_purchase_price" name="default_purchase_price" min="0" value="{{ old('default_purchase_price') }}" required
                                   class="w-full px-4 py-2.5 bg-slate-50 border border-slate-200 rounded-xl text-sm focus:border-emerald-500 focus:ring-emerald-500/20">
                        ...
                        <div>
                            ...
                            <input type="number" id="selling_price" name="selling_price" min="0" value="{{ old('selling_price') }}" required
                                   class="w-full px-4 py-2.5 bg-slate-50 border border-slate-200 rounded-xl text-sm focus:border-emerald-500 focus:ring-emerald-500/20">
                        ...
                        <div>
                            ...
                            <input type="number" id="minimum_stock" name="minimum_stock" min="0" value="{{ old('minimum_stock', 10) }}" required
                                   class="w-full px-4 py-2.5 bg-slate-50 border border-slate-200 rounded-xl text-sm focus:border-emerald-500 focus:ring-emerald-500/20">
                    ...
                    <div>
                        ...
                        <textarea id="description" name="description" rows="3"
                                  class="w-full px-4 py-2.5 bg-slate-50 border border-slate-200 rounded-xl text-sm focus:border-emerald-500 focus:ring-emerald-500/20">{{ old('description') }}</textarea>

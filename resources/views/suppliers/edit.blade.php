<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center gap-3">
            ...
            <h2 class="text-xl font-bold text-slate-800">Edit Supplier</h2>
        </div>
    </x-slot>
                ...
                <form action="{{ route('suppliers.update', $supplier) }}" method="POST" class="space-y-5">
                    ...
                    <div>
                        ...
                        <textarea name="address" id="address" rows="3"
                                  class="w-full px-4 py-2.5 bg-slate-50 border border-slate-200 rounded-xl text-sm focus:border-emerald-500 focus:ring-emerald-500/20">{{ old('address', $supplier->address) }}</textarea>
